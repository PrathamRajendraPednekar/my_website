          ...
          <div className="space-y-4">
            {achievements.map((item, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ 
                   default: { delay: 0.2 + (i * 0.1), duration: 0.5 },
                ...
                className="glass flex items-center gap-6 p-5 rounded-2xl border-white/5 hover:border-accent-blue/30 transition-colors duration-100 group cursor-default"
              >
